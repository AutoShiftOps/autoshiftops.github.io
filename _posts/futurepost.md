...
![emqx-kafka](/assets/images/posts/emqx-kafka-project/emqx-kafka.jpg)
...
![emqx-windows-docker](/assets/images/posts/emqx-kafka-project/emqx/emqx-windows.png)
...
![running emqx docker](/assets/images/posts/emqx-kafka-project/emqx/running-emqx-docker.png)
...
![webpage](/assets/images/posts/emqx-kafka-project/emqx/webpage.png)
...
![dashboard](/assets/images/posts/emqx-kafka-project/emqx/dashboard.png)
...
- #### Step 5: Execute the subscriber and Publisher
    ...
    ![emqx execution](/assets/images/posts/emqx-kafka-project/emqx/execution-emqx.png)
...
![kafka setup](/assets/images/posts/emqx-kafka-project/kafka/kafka-setup.png)
...
```
![kafka producer and consumer run](/assets/images/posts/emqx-kafka-project/kafka/kafka-exec.png)
...
![emqx and kafka merge](/assets/images/posts/emqx-kafka-project/kafka/emqx-kafka-together.png)
...
MongoInsertHandler(document)
```
![Inserting document](/assets/images/posts/emqx-kafka-project/mongo/mongo-insert.png)
...
![mongo console](/assets/images/posts/emqx-kafka-project/mongo/mongo-console.png)
